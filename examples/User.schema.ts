import { IsDefined, MinLength, IsDate as CVIsDate /* aliases work ok */ } from 'class-validator';
// Decorators that are not imported from CV are discarded
import IsSomething from 'some-module';

// Decorators that are not imported from CV are discarded
const GarbageDecorator = (): PropertyDecorator => (_target: any, _propertyKey: any) => { };
/*
